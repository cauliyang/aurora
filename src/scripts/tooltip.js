...
function createTooltipContent(elementData, element) {
    ...
    let content = `<div class="tooltip-header ${isNode ? 'node-header' : 'edge-header'}">
    ...
    if (isNode) {
        ...
        if (elementData.chrom) {
            content += `<div class="tooltip-section">
                ...
                <div class="tooltip-value">${elementData.chrom}:${elementData.ref_start?.toLocaleString() || '?'}-${elementData.ref_end?.toLocaleString() || '?'}</div>
            </div>`;
        }
        ...
        if (elementData.ptc !== undefined || elementData.ptf !== undefined) {
            ...
            if (elementData.ptc !== undefined) {
                content += `<div class="tooltip-metric">
                    ...
                    <span class="metric-value" style="background-color: #007bff;">${elementData.ptc.toFixed(4)}</span>
                </div>`;
            }
            ...
            if (elementData.ptf !== undefined) {
                content += `<div class="tooltip-metric">
                    ...
                    <span class="metric-value" style="background-color: #6c757d;">${elementData.ptf.toFixed(4)}</span>
                </div>`;
            }
