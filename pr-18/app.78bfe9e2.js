var e=globalThis,t={},o={},a=e.parcelRequire4cf7;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in o){var a=o[e];delete o[e];var r={id:e,exports:{}};return t[e]=r,a.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},e.parcelRequire4cf7=a),a.register;var r=a("5qD1E"),n=a("2UrZ2"),l=a("e8aKe"),i=a("ftuQo"),d=a("2pLFv");const s=document.getElementById("cy"),c=document.getElementById("info"),p=document.getElementById("walks"),g=document.getElementById("toggleMaximize");let m=!1;g?g.addEventListener("click",()=>{m?(s.style.width="",s.style.height="",c.style.display="",p.style.display="",m=!1):(s.style.width="100%",s.style.height="100vh",c.style.display="none",p.style.display="none",m=!0)}):console.warn("Element with ID 'toggleMaximize' not found in the DOM");const u=document.getElementById("hiddenLabel");u?u.addEventListener("click",function(){let e=(0,l.getLabelsVisible)()?"":function(e){return e.data("gene_name")?e.data("gene_name"):""},t=(0,l.getLabelsVisible)()?"":function(e){return e.data("weight")?e.data("weight"):""};r.STATE.cy.style().selector("node").style({label:e}).selector("edge").style({label:t}).update(),(0,l.setLabelsVisible)(!(0,l.getLabelsVisible)())}):console.warn("Element with ID 'hiddenLabel' not found in the DOM");const f=document.getElementById("captureGraph");async function h(e,t={}){let o,a;if(!r.STATE.cy)throw Error("No graph loaded");let{scale:n=2,fullGraph:l=!0,transparentBg:i=!1}=t,d=new Date().toISOString().slice(0,19).replace(/:/g,"-");switch(e){case"png":o=r.STATE.cy.png({full:l,scale:n,bg:i?"transparent":"#ffffff"}),a=`graph_${d}.png`;break;case"jpg":o=r.STATE.cy.jpg({full:l,scale:n,bg:"#ffffff",quality:.9}),a=`graph_${d}.jpg`;break;case"svg":let s=new Blob([r.STATE.cy.svg({full:l,bg:i?"transparent":"#ffffff"})],{type:"image/svg+xml"});o=URL.createObjectURL(s),a=`graph_${d}.svg`;break;case"json":let c=new Blob([JSON.stringify(r.STATE.cy.json(),null,2)],{type:"application/json"});o=URL.createObjectURL(c),a=`graph_${d}.json`;break;default:throw Error(`Unsupported format: ${e}`)}let p=document.createElement("a");p.href=o,p.download=a,p.click(),("svg"===e||"json"===e)&&setTimeout(()=>URL.revokeObjectURL(o),100)}f?f.addEventListener("click",()=>{!function(){if(!r.STATE.cy)return window.showAlert?.("No graph loaded to export","error");let e=document.getElementById("exportModal");e||(e=function(){let e=document.createElement("div");if(e.id="exportModal",e.className="modal fade",e.setAttribute("tabindex","-1"),e.innerHTML=`
